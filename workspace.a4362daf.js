parcelRequire=function(e,r,t,n)
{
    ...
    },f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};
    for(var c=0;c<t.length;c++)
        try{f(t[c])}catch(e){i||(i=e)}
    if(t.length)
    {
...
({"TCu9":[function(require,module,exports) {
    ...
    var a=function()
    {
        ...
        {
            e(this,t);
            var n=r.width,i=r.height,o=document.createElement("canvas");
            o.width=n,o.height=i;
            var u=o.getContext("2d");
            u.drawImage(r,0,0),this.canvas=o,this.context=u,this.frames=a
        }   
        return r(t,[{key:"drawFrame",value:function(e,t,r,a,n,i){var o=this.frames[t],u=o.x,s=o.y,c=o.width,h=o.height;r|=0,a|=0,n|=c,i|=h,e.drawImage(this.canvas,u,s,c,h,r,a,n,i)}}]),t
    }();
